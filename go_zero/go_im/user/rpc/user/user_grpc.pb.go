...
type UserClient interface {
	...
	Info(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error)
}
...
func (c *userClient) Info(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
...
type UserServer interface {
	...
	Info(context.Context, *GetUserRequest) (*GetUserResponse, error)
...
func (UnimplementedUserServer) Info(context.Context, *GetUserRequest) (*GetUserResponse, error) {
...
func _User_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Info(ctx, req.(*GetUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
